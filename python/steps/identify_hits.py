...
def identify_hits(participant_id, task_id, aois_file, progress, task):
    ...
    df_gps_x_aois.to_csv('{}/{}/{}/gp_x_aoi.csv'.format(__constants.output_folder, participant_id, task_id))
    ...
    for i, gp in df_gps_x_aois.iterrows():
        ...
        for j, aoi_to_consider in aois_to_consider.iterrows():
            ...
            x1 = aoi_to_consider['x1']
            x2 = aoi_to_consider['x2']
            y2 = __constants.total_surface_height - aoi_to_consider['y2']
            y1 = __constants.total_surface_height - aoi_to_consider['y1']
